...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        'service_wojsw1r', // Your service ID
        'template_3ef4wcl', // Your template ID
        formRef.current,
        '6bJ2xCa-80x4emxVX' // Your public key
      )
      .then(
        () => {
          setLoading(false);
      ...
      <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className='flex-[0.75] bg-black-100 p-8 rounded-2xl'>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <label className='flex flex-col'>
            ...
            <textarea name='message' value={form.message} onChange={handleChange} placeholder='What do you want to say?' className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium' />
          </label>
