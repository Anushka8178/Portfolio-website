  ...
  const projects = [
    {
      ...
      description:
      "A full-stack web application inspired by Airbnb, designed to connect travelers with hosts for booking accommodations",
      tags: [
        {
          name: "nodejs",
    ...
    },
    {
      ...
      description:
        "A tool that leverages AI to quickly retrieve and analyze Indian court cases based on criteria like state, police station, and case number, providing insights into case background, summaries, and potential outcomes.",
      tags: [
        {
          name: "LegalBert",
          color: "blue-text-gradient",
    ...
    },
    {
      ...
      description:
        "Real-time weather data at your fingertips with a React widget",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
    ...
    },
    {
      ...
      description:
        "Empowering cities with cutting-edge automation and smart systems",
      tags: [
        {
    ...
    },
    {
      ...
      description:
        "A study on relational extraction using the RAG approach and FLAN-T5 with the CONLL dataset to improve the extraction of meaningful relationships from structured text.",
      tags: [
        {
